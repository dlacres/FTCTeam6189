...
#pragma config(Motor,  motorA,          ltMotor,       tmotorNXT, PIDControl, reversed, encoder)
#pragma config(Motor,  motorC,          rtMotor,       tmotorNXT, PIDControl, reversed, encoder)
...
//#include "i_SumoSM.c"
		...
		case BACKUP:
			...
			if (isRobotDistanceClicks(100)){
				nextState=TURN;
				//turnClicks=400;
				turnClicks=RandomNumberBetween(800,1200);
				ResetRobotClicks();
			}
			break;
		case TURN:
