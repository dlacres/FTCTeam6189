...
//speedCmd=0;
    ...
    DebugInt("irval",SensorValue[IR]);
		...
		writeDebugStreamLine("%3i,%3i,%4i,%4i,%3i,%3i,%3i, %4i, %4i,%d",iFrameCnt,pathIdx,distInches,IRval,speedCmd,SensorValue[IR],state, nMotorEncoder[rtMotor], nMotorEncoder[ltMotor],s);
		//--------------------------Robot Code--------------------------//
